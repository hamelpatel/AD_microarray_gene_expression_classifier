...
# DATE: 12/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-41890
# DISORDER: Multipls Sclerosis
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/3.MS/E-GEOD-41890"
...
#raw data only
#data_raw=getAE("E-GEOD-41890", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-41890", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-41890", type = "full")
...
# expression_data <- getGEO("GSE17048", GSEMatrix =TRUE, getGPL=FALSE)
...
dim(phenotype_data)
table(phenotype_data$FactorValue..DISEASE.STATUS.)
# 
# 
...
Diagnosis<-phenotype_data_subset[10]
colnames(Diagnosis)<-"Diagnosis"

Gender<-phenotype_data_subset[16]
...
Diagnosis[grep("relapse|remission", Diagnosis[,1]),]<-"case"
table(Diagnosis)
