...
# DATE: 18/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-42057
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/8.Chronic_Obstructive_Pulmonary_Disease/E-GEOD-42057"
...
#raw data only
#data_raw=getAE("E-GEOD-42057", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-42057", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-42057", type = "full")
...
Age<-phenotype_data_subset[45]
colnames(Age)<-"Age"

Diagnosis<-phenotype_data_subset[2]
colnames(Diagnosis)<-"Diagnosis"

Gender<-phenotype_data_subset[55]
...
# ncol(expression_data2)==nrow(phenotype_data)
