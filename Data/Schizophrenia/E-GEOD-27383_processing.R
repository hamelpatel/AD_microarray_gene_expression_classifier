...
# DATE: 12/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-27383
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/4.Schizophrenia/E-GEOD-27383/"
...
#raw data only
#data_raw=getAE("E-GEOD-27383", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-27383", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-27383", type = "full")
...
names(phenotype_data)
# 
# table(phenotype_data$FactorValue..disease.)
...
Tissue<-phenotype_data[1]
colnames(Tissue)<-"Tissue"

Age<-phenotype_data[1]
colnames(Age)<-"Age"

Diagnosis<-phenotype_data[6]
...
Diagnosis[grep("schizophrenia", Diagnosis[,1]),]<-"case"
table(Diagnosis)
...
pdf("Probe_detection_threshold_based_on_CLINICAL_gender_specific_and_house_keeping_genes_TEST.pdf", height=15, width = 12)
plot_Gender_specific_genes_entrez(expression_data_QCd_entrez_id_unique_pheno, gender_comparison[1], gene_entrez_list, 6, paste(dataset, "case_samples", sep="_"))
dev.off()
