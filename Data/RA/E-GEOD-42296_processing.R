...
# DATE: 16/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-42296
...
# NOTES - 
# no controls
# - removing Crohn's disease as all infants
# 
# 
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/7.Rheumatoid_Arthritis/E-GEOD-42296"
...
#raw data only
#data_raw=getAE("E-GEOD-42296", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-42296", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-42296", type = "full")
...
table(phenotype_data$FactorValue..TIME.)
table(phenotype_data$FactorValue..DISEASE.STATE.)

phenotype_data_subset<-phenotype_data[phenotype_data$FactorValue..TIME.=="week 0" & phenotype_data$FactorValue..DISEASE.STATE.=="rheumatoid arthritis",]
head(phenotype_data_subset)
table(phenotype_data_subset$FactorValue..TIME.)
table(phenotype_data_subset$FactorValue..DISEASE.STATE.)
...
Tissue<-phenotype_data_subset[10]
colnames(Tissue)<-"Tissue"

Age<-phenotype_data_subset[1]
colnames(Age)<-"Age"

Diagnosis<-phenotype_data_subset[7]
...
table(predicted_gender$Predicted_Gender)
