...
# DATE: 16/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-54629
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/7.Rheumatoid_Arthritis/E-GEOD-54629"
...
#raw data only
#data_raw=getAE("E-GEOD-54629", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-54629", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-54629", type = "full")
...
table(phenotype_data$FactorValue..treatment.)

phenotype_data_subset<-phenotype_data[phenotype_data$FactorValue..treatment.=="rituximab treated baseline",]
head(phenotype_data_subset)
table(phenotype_data_subset$FactorValue..treatment.)
...
Diagnosis<-phenotype_data_subset[38]
...
Diagnosis[grep("rituximab treated baseline", Diagnosis[,1]),]<-"case"
table(Diagnosis)
