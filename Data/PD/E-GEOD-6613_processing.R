...
# DATE: 11/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-6613
...
# controls were taken in AD dataset - using same detection threshold as AD adataset - 0.7
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/2.PD/E-GEOD-6613"
...
#raw data only
#data_raw=getAE("E-GEOD-6613", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-6613", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-6613", type = "full")
...
phenotype_data_subset<-subset(phenotype_data, FactorValue..disease. == "Parkinson's disease")
dim(phenotype_data_subset)
table(phenotype_data_subset$FactorValue..disease.)
