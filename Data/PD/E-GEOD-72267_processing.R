...
# DATE: 11/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-72267
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/2.PD/E-GEOD-72267/"
...
#raw data only
#data_raw=getAE("E-GEOD-72267", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-72267", type = "processed")

#all data
data_raw=getAE("E-GEOD-72267", type = "full")
...
Diagnosis<-phenotype_data[27]
colnames(Diagnosis)<-"Diagnosis"

Gender<-phenotype_data[1]
...
Diagnosis[grep("Parkinson's disease", Diagnosis[,1]),]<-"case"
table(Diagnosis)
