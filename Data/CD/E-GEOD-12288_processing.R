...
# DATE: 13/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-12288
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/6.Cardiovascular_Disease/E-GEOD-12288/"
...
#raw data only
#data_raw=getAE("E-GEOD-12288", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-12288", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-12288", type = "full")
...
table(phenotype_data$'FactorValue..PATIENT.GROUP.')
...
# Diagnosis[grep("Yes", Diagnosis[,1]),]<-"case"
table(Diagnosis)
