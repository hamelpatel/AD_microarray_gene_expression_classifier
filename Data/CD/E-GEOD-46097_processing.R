...
# DATE: 13/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-46097
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/6.Cardiovascular_Disease/E-GEOD-46097/"
...
#raw data only
#data_raw=getAE("E-GEOD-46097", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-46097", type = "processed")

#all data
data_raw=https_getAE("E-GEOD-46097", type = "full")
...
table(phenotype_data$FactorValue..CAD.)
...
Age<-phenotype_data[5]
colnames(Age)<-"Age"

Diagnosis<-phenotype_data[43]
colnames(Diagnosis)<-"Diagnosis"

Gender<-phenotype_data[46]
