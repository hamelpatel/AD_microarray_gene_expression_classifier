...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/1.AD/E-GEOD-6613/"
...
phenotype_data_subset<-subset(phenotype_data, FactorValue..disease. %in% c("Alzheimers disease", "normal"))
...
Diagnosis[grep("Alzheimers disease", Diagnosis[,1]),]<-"case"
table(Diagnosis)
