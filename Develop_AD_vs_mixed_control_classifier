...
# Note: 
# 
# DEFAULT WEIGHTS - UPSAMPLE INDIVIDUAL CONTROLS + CASES
#
#
...
# # 9. tune eta (0.01:0.2, increasing by 0.01)
# 
#
# using logloss
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/6.XGBoost/upsampling/AD_specific_classifier_logloss_FINAL/"
...
#training_data$sample_ID<-row.names(training_data)
training_data<-caret::upSample(training_data, as.factor(training_data$Diagnosis))
dim(training_data)
table(training_data$Diagnosis)

#add dummy column for AD or control
training_data$AD<-training_data$Diagnosis
training_data$AD[grep("AD_case", training_data$AD)]<-"AD"
training_data$AD[grep("AD", training_data$AD, invert = T)]<-"control"
table(training_data$AD)

# upsample AD

training_data<-caret::upSample(training_data, as.factor(training_data$AD))
dim(training_data)
table(training_data$Diagnosis)
table(training_data$AD)

#remove unwanted columns
training_data$AD<-NULL
training_data$Class<-NULL
training_data$Class<-NULL

#check column number the same
ncol(data)==ncol(training_data)
...
plot(tune_results_1$evaluation_log$train_logloss_mean, type = 'l', col="green", main="Train and Test error logloss")
lines(tune_results_1$evaluation_log$test_logloss_mean, type = 'l', col="red")
...
#order
RFE_results_lowest_logloss<-RFE_results_lowest_logloss[order(RFE_results_lowest_logloss$test_mlogloss_mean),]
RFE_results_lowest_logloss

plot(RFE_results[[eval(RFE_results_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(RFE_results[[eval(RFE_results_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(RFE_results[[eval(RFE_results_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
#order
tune_results_2_lowest_logloss<-tune_results_2_lowest_logloss[order(tune_results_2_lowest_logloss$test_mlogloss_mean),]
tune_results_2_lowest_logloss


plot(tune_results_2[[eval(tune_results_2_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_2[[eval(tune_results_2_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_2[[eval(tune_results_2_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
#order
tune_results_3_lowest_logloss<-tune_results_3_lowest_logloss[order(tune_results_3_lowest_logloss$test_mlogloss_mean),]
tune_results_3_lowest_logloss

plot(tune_results_3[[eval(tune_results_3_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_3[[eval(tune_results_3_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_3[[eval(tune_results_3_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
plot(tune_results_4[[eval(tune_results_4_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_4[[eval(tune_results_4_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_4[[eval(tune_results_4_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
#order
tune_results_5_lowest_logloss<-tune_results_5_lowest_logloss[order(tune_results_5_lowest_logloss$test_mlogloss_mean),]
tune_results_5_lowest_logloss

plot(tune_results_5[[eval(tune_results_5_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_5[[eval(tune_results_5_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_5[[eval(tune_results_5_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
#order
tune_results_6_lowest_logloss<-tune_results_6_lowest_logloss[order(tune_results_6_lowest_logloss$test_mlogloss_mean),]
tune_results_6_lowest_logloss

plot(tune_results_6[[eval(tune_results_6_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_6[[eval(tune_results_6_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_6[[eval(tune_results_6_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
plot(tune_results_7$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_7$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_7$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
#order
tune_results_7_lowest_logloss<-tune_results_7_lowest_logloss[order(tune_results_7_lowest_logloss$test_mlogloss_mean),]
tune_results_7_lowest_logloss

plot(tune_results_7[[eval(tune_results_7_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_7[[eval(tune_results_7_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_7[[eval(tune_results_7_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
plot(tune_results_8$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_8$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_8$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
#order
tune_results_8_lowest_logloss<-tune_results_8_lowest_logloss[order(tune_results_8_lowest_logloss$test_mlogloss_mean),]
tune_results_8_lowest_logloss

plot(tune_results_8[[eval(tune_results_8_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_8[[eval(tune_results_8_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_8[[eval(tune_results_8_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
#order
tune_results_9_lowest_logloss<-tune_results_9_lowest_logloss[order(tune_results_9_lowest_logloss$test_mlogloss_mean),]
tune_results_9_lowest_logloss

plot(tune_results_9[[eval(tune_results_9_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, ylim=c(min(tune_results_9[[eval(tune_results_9_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean),1) , type = 'l', col="red")
lines(tune_results_9[[eval(tune_results_9_lowest_logloss[1,1])]]$evaluation_log$train_logloss_mean, type = 'l', col="green")
...
##### PLOT OF ALL TUNINING #####
#plot

plot(tune_results_1$evaluation_log$test_logloss_mean, ylim=c(0,1) , type = 'l', col="cyan")
lines(tune_results_1$evaluation_log$train_logloss_mean, type = 'l', col="red")
lines(RFE_results[[eval(RFE_results_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="cadetblue1")
lines(tune_results_2[[eval(tune_results_2_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="cyan1")
lines(tune_results_3[[eval(tune_results_3_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="cyan2")
lines(tune_results_4[[eval(tune_results_4_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="cyan3")
lines(tune_results_5[[eval(tune_results_5_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="cyan4")
lines(tune_results_6[[eval(tune_results_6_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="darkcyan")
lines(tune_results_7[[eval(tune_results_7_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="blue")
lines(tune_results_8[[eval(tune_results_8_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="blue4")
lines(tune_results_9[[eval(tune_results_9_lowest_logloss[1,1])]]$evaluation_log$test_logloss_mean, type = 'l', col="deeppink")
legend(40, 0.9, 
       legend=c("Train error 1", 
                "Test error 1 (default)",
                "Test error 1 after RFE (default)",
                "Test error 2 (max_depth)",
                "Test error 3 (min_child_weight)",
                "Test error 4 (gamma)",
                "Test error 5 (subsample)",
                "Test error 6 (colsample_bytree)",
                "Test error 7 (alpha)",
                "Test error 8 (lambda)",
                "Test error 9 (eta)"), 
       col=c("red", 
...
write.csv(importanceClean, file="importanceClean.csv")

#plot
ggplot(head(importance, 20), aes(x=reorder(Feature,Gain), y=Gain,fill=Gain))+ 
...
ggplot(head(importance), aes(x=reorder(Feature,Gain), y=Gain,fill=Gain))+ 
  geom_bar(stat="identity", position="dodge")+ coord_flip()+
  ylab("Relative importance")+
  xlab("Gene")+
  ggtitle("XGboost Variable Importance")+
...
tiff("variable_importance_top20.pdf", width = 8, height = 8, unit="in",  res=300)
ggplot(head(importance, 20), aes(x=reorder(Feature,Gain), y=Gain,fill=Gain))+ 
  geom_bar(stat="identity", position="dodge")+ coord_flip()+
  ylab("Relative importance")+
  xlab("Gene")+
...
importance_copy<-head(importance, 20)

#add names
head(importance_copy)
importance_copy$Feature<-c("LDHB",
                           "NDUFA1",
                           "RPL36AL",
                           "RPS23",
                           "C14orf166",
...
#plot
ggplot(importance_copy, aes(x=reorder(Feature,Gain), y=Gain,fill=Gain))+ 
  geom_bar(stat="identity", position="dodge")+ coord_flip()+
  ylab("Relative importance")+
  xlab("Gene")+
  ggtitle("XGboost Variable Importance")+
...
tiff("variable_importance_top20_Gene_symbol.tiff", width = 8, height = 8, unit="in",  res=300)
ggplot(importance_copy, aes(x=reorder(Feature,Gain), y=Gain,fill=Gain))+ 
  geom_bar(stat="identity", position="dodge")+ coord_flip()+
  ylab("Relative importance")+
  xlab("Gene")+
...
##### PREDICTION PROBABILITY - TRAINING DATA #####

# raw prediction for each sample
FINAL_train_prediction<-predict(best_model, RFE_training_data_xgb)

head(FINAL_train_prediction)

#merge diagnosis + dataset information
FINAL_train_prediction_missclassifcation<-training_data[1:2]
FINAL_train_prediction_missclassifcation$Prediction<-FINAL_train_prediction
head(FINAL_train_prediction_missclassifcation)

# add column if AD or not
FINAL_train_prediction_missclassifcation$Clinical<- ifelse(FINAL_train_prediction_missclassifcation$Diagnosis=="AD_case", "AD", "Non-AD")

head(FINAL_train_prediction_missclassifcation)
table(FINAL_train_prediction_missclassifcation$Clinical)

head(FINAL_train_prediction_missclassifcation)
table(FINAL_train_prediction_missclassifcation$Dataset)

# add column if illumina or AFFY
FINAL_train_prediction_missclassifcation$Platform<- ifelse(FINAL_train_prediction_missclassifcation$Dataset %in% c("AD_GSE63061", "SCZ_E_GEOD_48702"), "Illumina", "Affymetrix")

head(FINAL_train_prediction_missclassifcation)
table(FINAL_train_prediction_missclassifcation$Platform)

# susbet to non-AD
FINAL_train_prediction_missclassifcation_non_AD<-subset(FINAL_train_prediction_missclassifcation, FINAL_train_prediction_missclassifcation$Clinical=="Non-AD")
dim(FINAL_train_prediction_missclassifcation_non_AD)


# boxplot
ggplot(FINAL_train_prediction_missclassifcation, aes(x=Clinical, y=Prediction, color=Clinical)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality by AD Diagniosis") +
  theme(plot.title = element_text(hjust = 0.5))

# boxplot by dataset - by diagnosis

ggplot(FINAL_train_prediction_missclassifcation, aes(x=Diagnosis, y=Prediction, color=Diagnosis)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality by Clinical Diagnosis") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))

# boxplot by dataset - by dataset

ggplot(FINAL_train_prediction_missclassifcation, aes(x=Dataset, y=Prediction, color=Dataset)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality by Dataset") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))


# boxplot
ggplot(FINAL_train_prediction_missclassifcation_non_AD, aes(x=Platform, y=Prediction, color=Platform)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality of Non-AD samples by Platform") +
  ylim(0, 1) +
  theme(plot.title = element_text(hjust = 0.5))
...
pdf("Classification Prediction Probability on Training data by AD Diagnosis.pdf")
ggplot(FINAL_train_prediction_missclassifcation, aes(x=Clinical, y=Prediction, color=Clinical)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classification Prediction Probability on Training data by AD Diagnosis") +
  theme(plot.title = element_text(hjust = 0.5))
dev.off()

# pdf

pdf("Classification Prediction Probability on Training data by Clinical Diagnosis")
ggplot(FINAL_train_prediction_missclassifcation, aes(x=Diagnosis, y=Prediction, color=Diagnosis)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classification Prediction Probability on Training data by Clinical Diagnosis") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
pdf("Classification Prediction Probability on Training data by Dataset.pdf")
ggplot(FINAL_train_prediction_missclassifcation, aes(x=Dataset, y=Prediction, color=Dataset)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classification Prediction Probability on Training data by Dataset") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
pdf("Classification Prediction Probability on Training data of Non-AD samples by Platform.pdf")
# boxplot
ggplot(FINAL_train_prediction_missclassifcation_non_AD, aes(x=Platform, y=Prediction, color=Platform)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality on Training data of Non-AD samples by Platform") +
  ylim(0, 1) +
  theme(plot.title = element_text(hjust = 0.5))
dev.off()
...
# boxplot
ggplot(FINAL_test_prediction_missclassifcation, aes(x=Clinical, y=Prediction, color=Clinical)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality by AD Diagniosis") +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(FINAL_test_prediction_missclassifcation, aes(x=Diagnosis, y=Prediction, color=Diagnosis)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality by Clinical Diagnosis") +
  theme(plot.title = element_text(hjust = 0.5)) +
...
ggplot(FINAL_test_prediction_missclassifcation, aes(x=Dataset, y=Prediction, color=Dataset)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality by Dataset") +
  theme(plot.title = element_text(hjust = 0.5)) +
...
# boxplot
ggplot(FINAL_test_prediction_missclassifcation_non_AD, aes(x=Platform, y=Prediction, color=Platform)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classifcation Prediction Probality of Non-AD samples by Platform") +
  ylim(0, 1) +
...
pdf("Classification Prediction Probability by AD Diagnosis.pdf")
ggplot(FINAL_test_prediction_missclassifcation, aes(x=Clinical, y=Prediction, color=Clinical)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classification Prediction Probability by AD Diagnosis") +
  theme(plot.title = element_text(hjust = 0.5))
dev.off()

# pdf

tiff("Classification Prediction Probability by Clinical Diagnosis.tiff", width = 8, height = 8, unit="in",  res=300)
ggplot(FINAL_test_prediction_missclassifcation, aes(x=Diagnosis, y=Prediction, color=Diagnosis)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
...
tiff("Classification Prediction Probability by Clinical Diagnosis seperated.tiff", width = 8, height = 8, unit="in",  res=300)
ggplot(FINAL_test_prediction_missclassifcation_copy, aes(x=Diagnosis, y=Prediction, color=Diagnosis)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("(b) 'AD vs mixed control' classification model prediction probability") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
pdf("Classification Prediction Probability by Dataset.pdf")
ggplot(FINAL_test_prediction_missclassifcation, aes(x=Dataset, y=Prediction, color=Dataset)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ggtitle("Classification Prediction Probability by Dataset") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
pdf("Classification Prediction Probability of Non-AD samples by Platform.pdf")
# boxplot
ggplot(FINAL_test_prediction_missclassifcation_non_AD, aes(x=Platform, y=Prediction, color=Platform)) + 
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2)) +
...
best_model_ROC<-predict(best_model, RFE_testing_data_xgb)

best_model_ROC_pred<-prediction(best_model_ROC, as.factor(testing_data_pheno_xgb))

best_model_ROC_perf<-performance( best_model_ROC_pred, "tpr", "fpr" )

plot(best_model_ROC_perf, colorize = TRUE)

saveRDS(best_model_ROC_perf, file="AD_specific_best_model_ROC_perf")

##### GENDER #####

gender<-read.csv("/media/hamel/Workspace/Dropbox/Projects/AD-classification/5.YuGene_Transform/common_rd_genes/Gender.csv", row.names=1)

head(gender)

gender$sample_ID<-rownames(gender)

#merge with 

test<-training_data[c(1,1684)]
head(test)

test<-merge(test, gender, by="sample_ID", all=T)
dim(test)
head(test)

table(test$Predicted_Gender)
