...
# DATE: 09/05/2018
# ARRAY EXPRESS NUMBER: E-GEOD-63061
# DISORDER: Alzheimer's Disease
# MICROARRAY PLATFORM: Illumina
# EXPRESSION CHIP: HumanHT-12 v4.0
# NUMBER OF SAMPLES: 
# TISSUE: Whole Blood
#
# NOTES - 
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/1.AD/E-GEOD-63061"
...
#raw data only
#data_raw=getAE("E-GEOD-63061", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-63061", type = "processed")

#all data
#data_raw=getAE("E-GEOD-63061", type = "full")
...
expression_data <- getGEO("GSE63061", GSEMatrix =TRUE, getGPL=FALSE)
...
Probe_Detection_Threshold=0.75 
...
phenotype_data<-read.csv("/media/hamel/Workspace/Dropbox/Projects/AD-classification/1.Data/1.AD/ANM_pheno_form_Angela/ANM2_pheno_for_QC.csv")
rownames(phenotype_data)<-phenotype_data$Sample
phenotype_data$Sample<-NULL
...
pheno_temp<-pData(expression_data)[1]
...
phenotype_data_subset<-subset(phenotype_data, Diagnosis %in% c("AD", "CTL"))
...
plotDensity(head(expression_data_subset), logMode=F, addLegend=F)
