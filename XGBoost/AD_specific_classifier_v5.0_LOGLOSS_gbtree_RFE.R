...
work_dir="/media/hamel/Workspace/Dropbox/Projects/AD-classification/6.XGBoost/AD_specific_classifier_logloss_FINAL/"
...
# default paramaters except scale_pos_weight
...
params <- list(
  ...
  subsample=1,
  colsample_bytree=1,
  scale_pos_weight=table(training_data_pheno_xgb)[2]/table(training_data_pheno_xgb)[1] # Control the balance of positive and negative weights, useful for unbalanced classes. A typical value to consider: sum(negative cases) / sum(positive cases)
)
